...
size_t window(size_t n){if(window_override)return window_override;if(n<=4)return 2;if(n<=16)return 3;if(n<=160)return 4;if(n<=256)return 5;return 6;}
}}
namespace vme_ibf {
void set_gt_multiexp_window_override_for_benchmark(size_t w){if(w>8)throw std::invalid_argument("invalid GT MSM window override");window_override=w;}
