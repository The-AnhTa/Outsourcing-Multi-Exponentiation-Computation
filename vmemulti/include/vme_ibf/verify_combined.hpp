...
bool verify_deferred_combined(const VmeIbfCRS&,const VmeIbfPrecomputation&,const VmeIbfStatement&,const VmeIbfProof&);
CombinedVerificationTrace verify_deferred_combined_with_trace(const VmeIbfCRS&,const VmeIbfPrecomputation&,const VmeIbfStatement&,const VmeIbfProof&);
}
